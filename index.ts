 ...
 * @return {Date}
 */
function _toDate(val: number | string | Date, utc: boolean = true): Date {
 ...
 * @return {number}
 */
export function age(d: number | string | Date): number {
 ...
 * @return {string}
 */
export function iso(d: number | string | Date, time: boolean = true, utc:boolean = true): string {
 ...
 * @return {boolean}
 */
export function isToday(d: number | string | Date, utc: boolean = true): boolean {
 ...
 * @return {string}
 */
export function nice(d: number | string | Date, locale: string = 'en-US', text: 'long' | 'short' = 'long', time:boolean = true, utc: boolean = true): string {
 ...
 * @return {string}
 */
export function relative(d: number | string | Date, locale: string = 'en-US', text: 'long' | 'short'='long', utc: boolean = true): string {
